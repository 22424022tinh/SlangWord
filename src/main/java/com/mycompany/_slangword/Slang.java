...
public class Slang {
	...
	private static Slang obj = new Slang();// Early, instance will be created at load time
	private int sizeMap;
	private String FILE_SLANGWORD ="slangword.txt";

	private String FILE_ORIGINAL_SLANGWORD ="slang.txt";
	private String FILE_HISTORY = "slanghistory.txt";
	...
	public static Slang getInstance() {
		if (obj == null) {
			synchronized (Slang.class) {
				if (obj == null) {
					obj = new Slang();// instance will be created at request time
				}
			}
		}
		return obj;
